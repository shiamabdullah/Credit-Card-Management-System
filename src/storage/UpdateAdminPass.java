 ...
 * @author root
 */
class UpdateAdminPass extends JFrame {
    Container c;
    ...
    public UpdateAdminPass(String text)
    {
        c=getContentPane();
        c.setBackground(Color.gray);
        c.setLayout(null);
        ADATA= loginclass.adata;
        ...
        c.add(PassReset);
         PassReset.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) 
            {
             ...
             String query1 = "UPDATE `Admininfo` SET `pass`=? WHERE `a_id`=?";
             String query2="SELECT `pass` FROM `Admininfo` WHERE `a_id`=?";
